<section id="produtos">
    ...
    <div class="products-list">
        <div class="product-card" onclick="showImages('molduras')">
        ...
        <div class="product-card" onclick="showImages('batentes')">
        ...
        <div class="product-card" onclick="showImages('vigas')">
        ...
        <div class="product-card" onclick="showImages('painéis')">
    ...
    <div id="image-panel" class="image-panel" style="display: none;">
        <span onclick="closePanel()" style="cursor:pointer; float:right; font-size: 1.5rem;">&times;</span>
